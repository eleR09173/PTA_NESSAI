...
output = os.path.join(homedir, "SimulatedPSR", "outdir", "MultiPSR")
...
training_config = dict(
    patience=20 # is the number of iterations with no improvement in the validation loss to wait before stopping training early
)
